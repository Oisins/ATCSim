...
class Level {
    constructor(canvas) {
        ...
        this.ready = new __WEBPACK_IMPORTED_MODULE_0_rxjs_Subject__["Subject"]();
    ...
    create_level() {
        ...
        for (let runway of this.data.runways) {
            rwy = new __WEBPACK_IMPORTED_MODULE_1__runway__["a" /* Runway */](runway.x, runway.y, runway.length, runway.heading);
...
class Runway {
    constructor(x, y, length, heading) {
        this.x = x;
        this.y = y;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = Runway;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__classes_level__ = __webpack_require__(8);
